...
contract BaseSetup is Test {
  ...
  function setUp() public virtual {
    ...
    revenue = new Revenue();
    revenue.set(address(0), address(0), address(0));
...
contract OrderbookMatchTest is BaseSetup {
  ...
  function testLimitBuyETH() public {
    ...
    vm.prank(trader1);
    matchingEngine.limitBuyETH{ value: 1e18 }(address(token1), 1e8, true, 5, 0);
    vm.prank(trader1);
  ...
  function testMarketBuyETH() public {
    ...
    token1.approve(address(matchingEngine), 10e18);
    vm.prank(trader1);
    matchingEngine.marketSell(address(token1), address(weth), 1e18, true, 5, 0);
    console.log("weth balance");
    console.log(trader1.balance / 1e18);
  }
  ...
  function testMarketSellETH() public {
    ...
    token1.approve(address(matchingEngine), 10e18);
    vm.prank(trader1);
    matchingEngine.marketBuy(address(weth), address(token1), 1e18, true, 5, 0);
    console.log("weth balance");
    console.log(trader1.balance / 1e18);
  }
