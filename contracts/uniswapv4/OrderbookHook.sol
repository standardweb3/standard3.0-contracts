...
contract OrderbookHook is BaseHook, ERC1155 {
    ...
    function cancelOrder(
        ...
        require(amountIn > 0, "OrderbookHook: No orders to cancel");
    ...
    function redeem(
        ...
        require(
            ...
            "OrderbookHook: No tokens to redeem"
        );
        ...
        require(
            balance >= amountIn,
            "OrderbookHook: Not enough ERC-1155 tokens to redeem requested amount"
        );
