...
// OpenZeppelin src (last updated v5.0.0) (token/ERC721/extensions/ERC721Wrapper.sol)
...
abstract contract ERC721Wrapper is ERC721, IERC721Receiver {
    ...
    function depositFor(address account, uint256[] memory tokenIds) public virtual returns (bool) {
        ...
        for (uint256 i = 0; i < length; ++i) {
            ...
            // (by design of this contract) and no other src expected to be called from there, we are safe.
