...
// OpenZeppelin src (last updated v5.0.0) (token/ERC721/extensions/ERC721Consecutive.sol)
 ...
 * src this implies that batch minting is only available during proxy deployment, and not in subsequent upgrades.
