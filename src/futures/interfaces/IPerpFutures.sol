...
interface IPerpFutures {
    ...
    function setLeverageLimit(address base, address quote, address collateral, uint32 long, uint32 short) external returns (bool success);
    ...
    function closePositions(
        ...
        returns (
            uint32[] memory id,
            uint256[] memory markPrice,
            uint256[] memory mktPrice,
            int256[] memory pnl
        );
    ...
    function heads(
        ...
        address quote,
        address collateral
    ) external view returns (uint256 longHead, uint256 shortHead);
