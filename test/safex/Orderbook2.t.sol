...
import {MatchingEngine2} from "../../contracts/safex/MatchingEngine2.sol";
import {OrderbookFactory2} from "../../contracts/safex/orderbooks/OrderbookFactory2.sol";
import {Orderbook2} from "../../contracts/safex/orderbooks/Orderbook2.sol";

contract BaseSetup is Test {
    Utils public utils;
    MatchingEngine2 public matchingEngine;

    OrderbookFactory2 public orderbookFactory;
    Orderbook2 public book;
    ...
    function setUp() public virtual {
        ...
        matchingEngine = new MatchingEngine2();
        orderbookFactory = new OrderbookFactory2();
