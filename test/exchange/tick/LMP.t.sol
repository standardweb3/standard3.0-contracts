...
contract LMPTest is BaseSetup {
    // when sell order is empty, lmp is bidHead, and the market price goes up to 2% of the bidHead

    // when buy order is empty, lmp is askHead, and the market price goes down to 2% of the askHead
