...
contract ConversionTest is BaseSetup {
    ...
    function testInvalidConversion() public {
        super.setUp();
        matchingEngine.addPair(address(token1), address(token2), 100e8, 0, address(token1), new uint32[](0));
    ...
    function testConvertBuySellOnDifferentDecimalWhereBaseBQuote() public {
        super.setUp();
        matchingEngine.addPair(address(token1), address(btc), 1000e8, 0, address(token1), new uint32[](0));
    ...
    function testConvertBuySellOnDifferentDecimalWhereNotBaseBQuote() public {
        super.setUp();
        matchingEngine.addPair(address(btc), address(token2), 1000e8, 0, address(btc), new uint32[](0));
