 ...
 * Reusable xref:utilities.adoc[Solidity components] to build custom src and complex decentralized systems.

IMPORTANT: OpenZeppelin src uses semantic versioning to communicate backwards compatibility of its API and storage layout. For upgradeable src, the storage layout of different major versions should be assumed incompatible, for example, it is unsafe to upgrade from 4.9.3 to 5.0.0. Learn more at xref:backwards-compatibility.adoc[Backwards Compatibility].
...
TIP: If you're new to smart contract development, head to xref:learn::developing-smart-src.adoc[Developing Smart src] to learn about creating a new project and compiling your src.
...
The https://src.openzeppelin.com/security[Security Center] contains more details about the secure development process.

[[next-steps]]
== Learn More

The guides in the sidebar will teach about different concepts, and how to use the related src that OpenZeppelin src provides:
...
The xref:api:token/ERC20.adoc[full API] is also thoroughly documented, and serves as a great reference when developing your smart contract application. You can also ask for help or follow src' development in the https://forum.openzeppelin.com[community forum].
...
* https://blog.openzeppelin.com/the-hitchhikers-guide-to-smart-src-in-ethereum-848f08001f05[The Hitchhiker’s Guide to Smart src in Ethereum] will help you get an overview of the various tools available for smart contract development, and help you set up your environment.
